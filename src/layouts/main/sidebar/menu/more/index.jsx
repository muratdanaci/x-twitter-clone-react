...
export default function More() {
  return (
    <Popover className="relative">
      ...
      <Popover.Panel className="w-[318px] absolute bottom-0 left-0 bg-[#15202b] shadow-box shadow-[#8899a633] rounded-xl overflow-hidden">
        <button
          className={
            "px-4 h-14 inline-flex w-full items-center gap-6 hover:bg-[#eff3f41a] transition-colors"
          }
        >
          <svg
            viewBox="0 0 24 24"
